...
// Table Headers
const tableHeaders = [
    { text: 'Booking No', value: 'reservation_no', searchable: true },
    { text: 'C/IN', value: 'check_in' , searchable: true},
    { text: 'C/OUT', value: 'check_out', searchable: true},
    { text: 'Name', value: 'guest_name' , searchable: true},
    { text: 'Hotel', value: 'hotel.hotelName' , searchable: true},
        ...
        <div >
            ...
            <div class="flex justify-between items-center gap-2 mb-2">
                <div class="bg-white shadow-md px-4 py-2 rounded-lg w-1/2">
                    <h1 class="text-cyan-950 text-2xl font-bold py-0.5">{{monthName}} Reservations</h1>
                </div>
