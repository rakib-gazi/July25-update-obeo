...
<!--                                    </div>-->
<!--                                    &lt;!&ndash;check in & check out&ndash;&gt;-->
<!--                                    <div>-->
<!--                                        <div class="relative">-->
<!--                                            <label-->
...
<!--                                    </div>-->
<!--                                    &lt;!&ndash;hotel_id&ndash;&gt;-->
<!--                                    <div>-->
<!--                                        <div>-->
<!--                                            <Combobox v-model="selected">-->
<!--                                                <div class="relative">-->
<!--                                                    &lt;!&ndash; Floating Label &ndash;&gt;-->
<!--                                                    <label-->
<!--                                                        :class="[-->
...
<!--                                    </div>-->
<!--                                    &lt;!&ndash; Reservation Source &ndash;&gt;-->
<!--                                    <div>-->
<!--                                        <div>-->
...
<!--                                                </div>-->
<!--                                            </template>-->
<!--                                            &lt;!&ndash; Add Button: only show if childAges.length < 5 &ndash;&gt;-->
<!--                                            <button-->
...
<!--                                                        &lt;!&ndash; Remove Button (only if more than 1 room) &ndash;&gt;-->
<!--                                                        <button-->
<!--                                                            v-if="rooms.length > 1"-->
<!--                                                            type="button"-->
...
<!--                                        </div>-->
<!--                                    </div>-->
<!--                                    &lt;!&ndash; request & comments&ndash;&gt;-->
<!--                                    <div class="col-span-3 grid grid-cols-2 gap-2">-->
<!--                                        &lt;!&ndash;Guest Request no&ndash;&gt;-->
<!--                                        <div class="relative">-->
...
<!--                    <h1 class="text-cyan-950 text-2xl font-bold py-0.5">Today Added Reservations</h1>-->
<!--                </div>-->
...
<!--                    <div class="text-sm font-semibold">-->
<!--                        &lt;!&ndash; Reservation Status &ndash;&gt;-->
<!--                        <select-->
