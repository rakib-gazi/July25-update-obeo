  ...
  const form = reactive({
    ...
    defaults(fieldOrFields, maybeValue) {
      ...
      if (typeof fieldOrFields === "undefined") {
        ...
        defaults3 = typeof fieldOrFields === "string" ? set2(cloneDeep(defaults3), fieldOrFields, maybeValue) : Object.assign({}, cloneDeep(defaults3), fieldOrFields);
      }
      return this;
    },
    reset(...fields) {
      ...
      if (fields.length === 0) {
        ...
        fields.filter((key2) => has(clonedData, key2)).forEach((key2) => {
          set2(defaults3, key2, get(clonedData, key2));
